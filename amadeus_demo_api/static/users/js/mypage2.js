        ...
        var s,
          ...
          T = function (t) {
            ...
            for (e = 0; e < A.length; e++)
              if ((n = A[e] + i) in L.style) return { dom: n, css: O[e] + t };
          },
          C = (e.support = {
        ...
        var z = (e.frame =
          ...
          N = l(function (e) {
            ...
            (e.init = function (e) {
              ...
              C.backface &&
                H.hideBackface &&
                B(this.el, C.backface.css, "hidden");
            }),
              w("add", n),
              w("start", i),
              w("wait", function (t) {
          ...
          j = l(function (e) {
            function o() {
              var t,
                ...
                i = u.length;
              if (i)
                for (z(o), e = $(), t = i; t--; ) (n = u[t]) && n.render(e);
            }
        ...
        (t.exports = function (t, e) {
                  ...
                  m.button.on(
                    ...
                    function (t) {
                      switch (t.keyCode) {
                        ...
                        case o.ESCAPE:
                          return j(l), t.preventDefault(), t.stopPropagation();
                        case o.ARROW_RIGHT:
                        case o.ARROW_DOWN:
                        case o.HOME:
                        case o.END:
            ...
            c.preview =
              function () {
                (s = p && i.env("design")),
                  (u = i.env("editor")),
                  (n = t(document.body)),
                  (a = f.find(v)).length && (a.each(L), k(), i.resize.on(_));
              }),
            (c.destroy = function () {
          ...
          function N(e, n) {
            ...
            if ((!i.open || r || s || j(i, !0), i.container.length)) {
              var o,
                a =
                  ("none" === (o = i.container.css(D)) && (o = ""),
                  function (e, n) {
                    (n = t(n)).css(D, ""), "none" === n.css(D) && n.css(D, o);
                  });
